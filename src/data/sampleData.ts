import type { TripData, TodoItem, BudgetItem, PackingItem, TransportItem, AccommodationItem, ActivityItem, ReservationItem, ItineraryDay } from '@/types/honeymoon';
...
export const sampleTransport: TransportItem[] = [
  { id: '1', type: 'Flight', details: 'NYC → Athens (Delta DL412)', confirmation: 'DL8829', time: 'Sept 14, 10:30 PM' },
  { id: '2', type: 'Flight', details: 'Athens → Santorini (Aegean A3354)', confirmation: 'AE2241', time: 'Sept 15, 2:15 PM' },
  { id: '3', type: 'Ferry', details: 'Santorini → Mykonos (SeaJets)', confirmation: 'SJ7712', time: 'Sept 20, 9:00 AM' },
];

export const sampleAccommodations: AccommodationItem[] = [
  { id: '1', name: 'Canaves Oia Suites', address: 'Oia, Santorini', checkIn: 'Sept 15', checkOut: 'Sept 20', confirmation: 'CNV-88291' },
  { id: '2', name: 'Cavo Tagoo Mykonos', address: 'Tagoo, Mykonos', checkIn: 'Sept 20', checkOut: 'Sept 25', confirmation: 'CTV-44102' },
];

export const sampleActivities: ActivityItem[] = [
  { id: '1', name: 'Sunset Catamaran Cruise', notes: 'BBQ dinner included, bring swimsuit', time: 'Sept 16, 4:00 PM' },
  { id: '2', name: 'Wine Tasting in Pyrgos', notes: 'Santo Wines Winery, 4 varietals', time: 'Sept 17, 11:00 AM' },
  { id: '3', name: 'Couples Spa at Canaves', notes: 'Deep tissue + aromatherapy', time: 'Sept 18, 10:00 AM' },
  { id: '4', name: 'Delos Island Day Trip', notes: 'Ferry from Mykonos Old Port', time: 'Sept 22, 8:30 AM' },
];

export const sampleReservations: ReservationItem[] = [
  { id: '1', name: 'Ambrosia Restaurant', date: 'Sept 16', time: '7:30 PM', confirmation: 'AMB-221', notes: 'Cliffside table for 2' },
  { id: '2', name: 'Lycabettus Restaurant', date: 'Sept 17', time: '8:00 PM', confirmation: 'LYC-445', notes: 'Tasting menu requested' },
  { id: '3', name: 'Nammos Beach Club', date: 'Sept 21', time: '12:00 PM', confirmation: 'NMM-882', notes: 'Sunbed reservation' },
];

export const sampleItinerary: ItineraryDay[] = [
  {
    id: '1', dayLabel: 'Day One', destination: 'Arrival in Oia',
    activities: [
  ...
  {
    id: '2', dayLabel: 'Day Two', destination: 'Sailing the Caldera',
    activities: [
  ...
  {
    id: '3', dayLabel: 'Day Three', destination: 'Pyrgos & Wine Country',
    activities: [
  ...
  {
    id: '4', dayLabel: 'Day Four', destination: 'Spa & Relaxation',
    activities: [
  ...
  {
    id: '5', dayLabel: 'Day Five', destination: 'Red Beach & Akrotiri',
    activities: [
