    ...
    <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] lg:grid-cols-[340px_1fr] gap-5 md:gap-6 lg:gap-10 xl:gap-14 items-stretch">
      ...
      >
        ...
        <button
          ...
          className="w-full flex-1 rounded-2xl overflow-hidden bg-accent/40 border border-border relative group cursor-pointer"
        >
        ...
        {/* Script text */}
        <p className="font-script text-2xl md:text-3xl lg:text-[36px] xl:text-[42px] text-foreground/40 mt-5 md:mt-6 text-center tracking-tight lowercase leading-tight">
          {quote}
        </p>
      </motion.div>
    </div>
